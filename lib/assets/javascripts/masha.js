...
MaSha.prototype = {
    ...
    *
    ...
    getSelection: function(){
        ...
        return {text: this.currentRange.getSelectedText(), location: this.serializeRange(this.currentRange)};
    },
    ...
    *
    ...
    checkPosition: function(range, offset, container, position) {
        ...
        if (position == 'start') {
            ...
            if (parentWithClass(container, 'anchor')){
                container = this.nextNode(container, /.*/)._container;
                console.log("starting with anchor");
            }
        ...
        if (position == 'end') {
            ...
            if (parentWithClass(container, 'anchor')){
                console.log("ending with anchor");
                container = this.prevNode(container, /.*/)._container;
            }
...
Range.prototype.getSelectedText = function(){
    this.splitBoundaries();
    var textNodes = this.getTextNodes();
    return textNodes.map(function(x){return x.data;}).join('');
};
