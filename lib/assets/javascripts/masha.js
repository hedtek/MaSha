...
MaSha.prototype = {
    ...
    *
    ...
    addSelection: function(range) {
        ...
        class_name = this.loadSelection(this.serializeRange(range));
     ...
     *
     */
    loadSelection: function(range) {
        if (typeof range !== "string"){
            return;
        }

        class_name = 'num'+this.counter;
        this.ranges[class_name] = range;
        this.counter++;
    ...
    *
    ...
    deserializePosition: function(bits, pos){
         ...
         // getting block
         var node = this.blocks[this.currentPage][parseInt(bits[0], 10)];
            ...
            for (var idx=0; idx<children.length; ++idx) {
                ...
                if (nodeType==3 && !child.nodeValue.match(this_.regexp)) {
                    ...
                    if (!blockStarted){
                        ...
                        idx++;
                        this_.blocks[this_.currentPage][MaSha.captureCount] = child;
